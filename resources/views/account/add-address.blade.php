                        ...
                        @if (!empty($result))
                            <div class="form-group row">
                                    ...
                                    <div class="col alert alert-success">
                                        <strong>{{ __('The address has been saved successfully!')}}</strong>
                                    </div>
                                    @else

                                    <div class="col alert alert-danger">
                                        <strong>{{ __('There was an error while saving address')}}</strong>
                                    </div>
                                    @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pincode" type="number" min="1"
                                           ...
                                           name="pincode" value="{{ old('pincode') }}" required autofocus>
